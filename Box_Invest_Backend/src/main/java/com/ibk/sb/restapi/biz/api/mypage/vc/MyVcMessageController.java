...
@Slf4j
@RestController
@Api(tags = {"투자사 마이페이지 메시지 서비스 API"})
@RequestMapping(path = {"/api/my/vc/message", "/api/iv/v1/my/vc/message"}, produces = {MediaType.APPLICATION_JSON_VALUE})
@RequiredArgsConstructor
public class MyVcMessageController {
    ...
    public ResponseData searchVCRecentMessageList() throws Exception {
    ...
    public ResponseData searchVCMessage(@PathVariable("id") String id) throws Exception {
    ...
    public ResponseData searchReceiveMessageList(RequestMessageVO requestMessageVO) throws Exception{
    ...
    public ResponseData searchReceiveMessageCount() throws Exception {
    ...
    public ResponseData searchSendMessageList(RequestMessageVO requestMessageVO) throws Exception {
     ...
     * @return
     */
    @ApiOperation(value = "메시지 전체 읽음 요청 처리")
    @PostMapping("/read/all/{type}")
    public ResponseData saveMessageReadAll(@PathVariable("type") String type) throws Exception {
