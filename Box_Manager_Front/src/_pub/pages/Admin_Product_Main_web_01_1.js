...
import ExBannerTableNew from 'pageComponents/commerce/main/ExBannerTableNew'
...
const Admin_Product_Main_web_01_1 = (props) => {
    ...
    data: [
      {
        ...
        title: '모바일 배너등록시 입력한 배너 제목',
        date: '2028.08.30-2028.08.30',
        status: <span className="status_ready">대기</span>,
        image: (
          <div className="no_img">
            <img src={NoImage02} alt="이미지 없음" />
      ...
      <div className="content_inner page_main">
        ...
        <div className="commerce_banner_wrap">
          ...
          {tabList.active === 'webMain' ? (
            <ExBannerTableNew dataList={webMainData} handleView={handleView} />
          ) : tabList.active === 'MobileMain' ? (
            <ExBannerTableNew dataList={mobileMainData} handleView={handleView} />
          ) : (
            ''
          )}
...
export default Admin_Product_Main_web_01_1
