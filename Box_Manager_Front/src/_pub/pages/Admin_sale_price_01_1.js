...
import ExSaleTableNew from 'pageComponents/commerce/main/ExSaleTableNew'
...
const Admin_sale_price_01_1 = (props) => {
    ...
    <PageLayout currentMenu={'commerce'} currentCate={'main'} currentPage={'bannerList'}>
      ...
      <div className="content_inner page_main">
        ...
        <div className="commerce_banner_wrap">
          ...
          <ExSaleTableNew dataList={saleData} handleView={handleView} />
...
export default Admin_sale_price_01_1
