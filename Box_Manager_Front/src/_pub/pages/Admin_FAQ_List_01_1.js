...
import ExFaqTableNew from 'pageComponents/commerce/main/ExFaqTableNew'
...
const Admin_FAQ_List_01_1 = (props) => {
  const faqData = {
    header: [
      {
        first: '번호',
    ...
    <PageLayout currentMenu={'commerce'} currentCate={'main'} currentPage={'bannerList'}>
      ...
      <div className="content_inner page_main">
        ...
        <div className="commerce_banner_wrap">
          ...
          <ExFaqTableNew dataList={faqData} handleView={handleView} />
...
export default Admin_FAQ_List_01_1
