...
import ExEventTableNew from 'pageComponents/commerce/main/ExEventTableNew'
import ExEventStatusTableNew from 'pageComponents/commerce/main/ExEventStatusTableNew'
...
const Admin_event_List_01_1 = (props) => {
    ...
    header: [
      {
        ...
        status: '상태',
        image: '대표 이미지',
        partinCompany: '참여 기업수',
        partinProduct: '참여 상품수 (승인/승인대기)',
        total: '총 판매 금액(원)'
      }
    ],
    data: [
      ...
      <div className="content_inner page_main">
        ...
        <div className="commerce_banner_wrap">
          ...
          {tabList.active === 'eventListTab' ? (
            <ExEventTableNew dataList={eventListData} handleView={handleView} />
          ) : tabList.active === 'eventStatusTab' ? (
            <ExEventStatusTableNew dataList={eventStatusData} handleView={handleView} />
          ) : (
            ''
          )}
...
export default Admin_event_List_01_1
