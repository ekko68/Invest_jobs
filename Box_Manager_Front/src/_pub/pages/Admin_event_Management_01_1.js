...
const Admin_event_Management_01_1 = (props) => {
          ...
          <table className="table form_table bg_none border_none">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <TextInput title="이벤트명" placeholder="이벤트명을 입력하세요." value={''} onChange={() => {}} />
                </td>
              </tr>
...
export default Admin_event_Management_01_1
