...
import ExThemeTableNew from 'pageComponents/commerce/main/ExThemeTableNew'
...
//   startdescript: new Date(),
//   enddescript: new Date()
// })

const Admin_Enterprise_Theme_01_1 = (props) => {
      ...
      <div className="content_inner page_main">
        ...
        <div className="commerce_banner_wrap">
          <div className={'maximum_notice'}>
            <p className="require highlight_grey">기업 메인 화면에 테마 기업 그룹을 등록 할 수 있습니다.</p>
          </div>
          ...
          <ExThemeTableNew dataList={mainData} handleView={handleView} />
...
export default Admin_Enterprise_Theme_01_1
