...
const Admin_Product_Main_web_01_1_Orderpop = (props) => {
      ...
      <div className="popup_container">
        <div className="popup_content scroll">
          <div className="popup_main_header">
            <div className="title">상품메인 노출순서 관리</div>
            <Button className="popup_close_button" aria-label="팝업 닫기" onClick={() => {}} />
          </div>
          <div className="order_prewview_section">
            {/* skeleton 일 때 swiper_wrap 에 is-skeleton 클래스 추가  */}
            <div className="swiper_wrap">
              <Swiper data={SwiperMain} />
            </div>
          </div>
          <div className="order_prewview_text">
            1순위 노출 : YYYY.MM.DD ~ YYYY.MM.DD
...
export default Admin_Product_Main_web_01_1_Orderpop
