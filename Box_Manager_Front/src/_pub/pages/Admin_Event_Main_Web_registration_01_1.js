...
const Admin_Event_Main_Web_registration_01_1 = (props) => {
    ...
    <PageLayout currentMenu={'commerce'} currentCate={'main'} currentPage={'bannerList'}>
      <div className="content_inner page_main">
        <div className="page_header">
          <h4 className="page_title">이벤트 메인 (웹) 배너 관리</h4>
        </div>
        {/*table_wrap start*/}
          ...
          <table className="table form_table bg_none border_none">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <TextInput title="설명" placeholder="설명을 입력하세요." value={''} length={15} onChange={() => {}} />
                </td>
              </tr>
              <tr>
...
export default Admin_Event_Main_Web_registration_01_1
