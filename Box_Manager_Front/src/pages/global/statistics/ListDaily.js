...
import { getConsultStatisticsDaily, getConsultStatisticsExcel } from '../../../modules/consts/AdminApi'
...
const List = () => {
  ...
  const getList = async (params) => {
    ...
    let res = await getConsultStatisticsDaily(paramsList) // 목록
  ...
  return (
    <PageLayout currentMenu={'global'} currentCate={'globalConsult'} currentPage={'globalStatisticsList'}>
      <div className="content_inner page_static">
        ...
        <div className="static_table">
          <table className="table type02">
            <caption>일별 접속이력 현황 테이블</caption>
            <colgroup>
              <col width={'40%'} />
              <col width={'*'} />
            </colgroup>
