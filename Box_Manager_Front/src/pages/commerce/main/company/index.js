...
import { searchStatus, searchInput, searchDate } from 'pages/commerce/main/company/searchValue'
import List from 'pageComponents/commerce/main/company/List'
import {
  getBannerListApiV2,
  deleteBannerApiV2,
...
const Comapny = (props) => {
  ...
  const handleRegistrationView = (id) => {
    // 등록화면
    history.push(`${ROUTER_NAMES.COMMERCE_MAIN_COMPANY_REGISTRATION}`)
  }
    ...
    <PageLayout currentMenu={'commerce'} currentCate={'main'} currentPage={'companyList'}>
      ...
      <div className="content_inner page_main">
        <div className="page_header">
          <h4 className="page_title">기업 메인</h4>
        </div>
