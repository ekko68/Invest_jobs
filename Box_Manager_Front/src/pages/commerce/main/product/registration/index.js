...
const Registration = (props) => {
  ...
  const handleSaveCb = () => {
    mktContext.actions.setCommonAlertInfo({
      ...
      msg: '저장되었습니다.',
      action: () => {
        history.push(`${ROUTER_NAMES.COMMERCE_MAIN_PRODUCT}`, { webYn: mktContext.state.currType })
      }
    })
  }
  ...
  const handleUpdateDataSet = async () => {
    ...
    if (res.data.code === '200') {
      ...
      if (_conData) {
        setConData({
          ttlTxt1: _conData.ttlTxt1,
          ttlTxt2: _conData.ttlTxt2,
          ttlTxt3: _conData.ttlTxt3,
          conTxt1: _conData.conTxt1,
          conTxt2: _conData.conTxt2,
          conTxt3: _conData.conTxt3
        })
      }
      await loader()
    }
