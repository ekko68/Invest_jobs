...
import { searchStatus, searchInput, searchDate } from 'pages/commerce/main/event/searchValue'
import List from 'pageComponents/commerce/main/event/List'
...
const Event = (props) => {
  ...
  const handleRegistrationView = (id) => {
    // 등록화면
    history.push(`${ROUTER_NAMES.COMMERCE_MAIN_EVENT_REGISTRATION}`)
  }
    ...
    <PageLayout currentMenu={'commerce'} currentCate={'main'} currentPage={'eventList'}>
      ...
      <div className="content_inner page_main">
        <div className="page_header">
          <h4 className="page_title">이벤트 메인</h4>
        </div>
