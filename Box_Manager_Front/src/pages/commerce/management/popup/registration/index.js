...
import { getPopupDetailApi, savePopupApiV2 } from 'modules/consts/MktApi'
...
const Registration = (props) => {
  ...
  const handleSave = () => {
    ...
    savePopupApiV2(data, handleSaveCb, handleSaveErrCb)
  }
  ...
  const handleSaveCb = () => {
    mktContext.actions.setCommonAlertInfo({
      ...
      msg: '저장되었습니다.',
      action: () => {
        history.push(`${ROUTER_NAMES.COMMERCE_MANAGEMENT_POPUP}`)
      }
    })
  }
                  ...
                  <div className="img_info_wrap">
                    <div className="img_wrap">
                      <ImageUpload
                        ...
                        form={data}
                        setForm={setData}
                        subText="첨부 이미지 권장 사이즈는 가로 600px(픽셀)을 권장합니다."
                      />
