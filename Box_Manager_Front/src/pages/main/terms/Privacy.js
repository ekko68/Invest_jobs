...
import { saveIBKBOXPersonalTerms, saveTerms } from 'modules/consts/MainApi'
...
const Privacy = () => {
  ...
  useEffect(() => {
    const getService = async () => {
      const res = await saveIBKBOXPersonalTerms()
  ...
  return (
    <PageLayout currentMenu={'mainBox'} currentCate={'mainTerms'} currentPage={'mainTermsPrivacy'}>
      ...
      <div className="content_inner page_terms">
        <div className="page_header">
          <h4 className="page_title">개인정보처리방침</h4>
