    ...
    <PageLayout currentMenu={'mainBox'} currentCate={'mainBanner'} currentPage={'mainBannerCardLimit'}>
      ...
      {popup.active && popup.type === "confirm" && (
        <PopupAlert msg={popup.text}
                    handlePopup={() => history.push(`${ROUTER_NAMES.MAIN_BANNER_CARDLIMIT_VIEW}/${saveData.bnnrSqn}`)} />
      )}
      ...
      <div className='content_inner pages_main main_write'>
        <h4 className='page_title'>카드한도조회(하단) 배너 {id ? "수정" : "등록"}</h4>


        <div className="table_wrap">
          <table className="table form_table bg_none border_none">
            <caption>카드한도조회(하단) 배너 테이블</caption>
            <colgroup>
              <col width={'13%'} />
              <col width={'*'} />
            </colgroup>
                    ...
                    <div className="upload_file">
                      ...
                      <div className="button_wrap">
                        ...
                        <p className="notice highlight_red require">
                          메인배너 적정사이즈는 가로 960px / 세로 300px 입니다.
                        </p>
                      </div>
