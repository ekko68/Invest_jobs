    ...
    <PageLayout currentMenu={'mainBox'} currentCate={'mainBanner'} currentPage={'mainBannerCommon'}>
      ...
      {popup.active && popup.type === "confirm" && (
        <PopupAlert msg={popup.text}
                    handlePopup={() => history.push(`${ROUTER_NAMES.MAIN_BANNER_COMMON_VIEW}/${saveData.bnnrSqn}`)} />
      )}
      ...
      <div className='content_inner pages_main main_write'>
        <h4 className='page_title'>PC화면배너(우측) {id ? "수정" : "등록"}</h4>
        <div className="table_wrap">
          <table className="table form_table bg_none border_none">
            <caption>PC화면배너(우측) 테이블</caption>
            <colgroup>
              <col width={'13%'} />
              <col width={'*'} />
            </colgroup>
            ...
            <tr>
              ...
              <td>
                <div className='preview pc_banner'>
                  {
                    ...
                    <div className="upload_file">
                      ...
                      <div className="button_wrap">
                        ...
                        <p className="notice highlight_red require">
                          메인배너 적정사이즈는 가로 384px / 세로 407px 입니다.
                        </p>
                      </div>
