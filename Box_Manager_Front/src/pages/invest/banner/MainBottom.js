...
import { getBannerMainBottom, saveBannerMainBottomList } from 'modules/consts/InvestApi'
...
const MainBottom = () => {
  ...
  const [confirmDelete, setConfirmDelete] = useState(null) // null or bannerList_0, bannerList_1
  ...
  const getBannerList = async () => {
    const res = await getBannerMainBottom()
  ...
  return (
    <PageLayout currentMenu={'invest'} currentCate={'banner'} currentPage={'mainBottom'}>
      ...
      <div className={'rounded_btn_group'}>
        ...
        <button
          ...
          onClick={() =>
            bannerFn.handleSave({list:bannerList, adminUser: userContext.actions.getIvtAdminUser()}, setAlertImg, saveBannerMainBottomList, getBannerList, setAlert)
          }
        >
          저장
        </button>
