...
import { getBannerMypageVc, saveBannerMypageVc } from 'modules/consts/InvestApi'
...
const InvestorMypage = () => {
  ...
  const getBannerList = async () => {
    const res = await getBannerMypageVc()
  ...
  return (
    <PageLayout currentMenu={'invest'} currentCate={'banner'} currentPage={'investorMypage'}>
      ...
      <div className={'rounded_btn_group'}>
        ...
        <button
          ...
          onClick={() => bannerFn.handleSave({list:bannerList, adminUser: userContext.actions.getIvtAdminUser()}, setAlertImg, saveBannerMypageVc, getBannerList, setAlert)}
        >
          저장
        </button>
      </div>
