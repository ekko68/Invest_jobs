...
const AxiosInvest = axios.create({
  baseURL: process.env.REACT_APP_IVT_API_URL,
  timeout: 300000
})

AxiosInvest.interceptors.request.use(
  function (config) {
    //
...
AxiosInvest.interceptors.response.use(
  (response) => {
