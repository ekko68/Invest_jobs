...
const RecommendSearchTable = (props) => {
  const { dataList, setDataList, delRcmdInfIds, setDelRcmdInfIds, handleToggle, goEditPage } = props
                  ...
                  dataList.list.map((item, idx) =>
                    item.oppbYn === 'Y' ? (
                      <Draggable key={item.srwdInfId} draggableId={item.srwdInfId} index={idx}>
                        {(provided) => (
                          <tr
                            key={'recommend_search_table_item_' + idx}
                      ...
                      <tr key={'recommend_search_table_item_' + idx}>
                        <td className={'ta_center'}>
                          <Checkbox
                            className="no_label"
                            checkbox={{ id: 'cell_check' + idx, value: '', status: true }}
...
export default RecommendSearchTable
