...
@Slf4j
@RestController
@Api(tags = {"기업 마이페이지 NDA 서비스 API"})
@RequestMapping(path = {"/api/my/company/nda", "/api/iv/v1/my/company/nda"}, produces = {MediaType.APPLICATION_JSON_VALUE})
@RequiredArgsConstructor
public class MyComNdaController {
    ...
    public ResponseData searchInvestNDAReceiveList(RequestSearchNdaVO requestSearchNdaVO) throws Exception {
     ...
     * @return
     */
    @ApiOperation(value = "보낸 NDA 목록 조회")
    @GetMapping("/send/list")
    public ResponseData searchInvestNDASendList(RequestSearchNdaVO requestSearchNdaVO) throws Exception {
    ...
    @PostMapping("/submit")
    public ResponseData submitInvestNDA(@RequestBody NdaVO ndaVO) throws Exception {
