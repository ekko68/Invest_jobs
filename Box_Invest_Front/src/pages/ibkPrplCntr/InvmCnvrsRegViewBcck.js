import { Add, CloseOutlined, FiberManualRecordOutlined, HomeOutlined, Remove } from '@mui/icons-material'
import {
  Avatar,
  Box,
  Button,
...
const InvmCnvrsRegViewBcck = (props) => {
            ...
            <Box>
              <Stack direction={'row'} divider={<Divider orientation="vertical" flexItem />}>
                ...
                <BtNavSelect defaultValue={10} onnItem={true}>
                  <MenuItem value={10} sx={{ fontSize: '1rem' }}>
                    마이페이지
                  </MenuItem>
                </BtNavSelect>
                <BtNavSelect defaultValue={10}>
                  ...
                  <MenuItem value={20} sx={{ fontSize: '1rem' }}>
                    Item 2
                  </MenuItem>
                  <MenuItem value={30} sx={{ fontSize: '1rem' }}>
                    Item 3
                  </MenuItem>
                </BtNavSelect>
                <BtNavSelect defaultValue={10}>
                ...
                <Stack direction={'column'} spacing={1}>
                  ...
                  <Grid container sx={{ borderTop: `2px solid ${theme.palette.primary.main}` }}>
                    <BtContentGrid gridXs={6} title={'회사명'}>
                      <TextField size="small" value={'(주)넥스파트너스'} sx={{ width: '100%' }} />
                    </BtContentGrid>
                    <BtContentGrid gridXs={6} title={'사업자 등록번호'}>
                      <TextField size="small" value={'123-45-6789123'} sx={{ width: '100%' }} />
                    </BtContentGrid>
                    ...
                    <BtContentGrid gridXs={12} title={'대표이사 정보'}>
                      <Stack direction={'row'} spacing={2} sx={{ width: '100%' }}>
                        <Stack direction={'row'} justifyContent="flex-start" alignItems="center" spacing={1}>
                          ...
                          <TextField size="small" value={'홍길동'} />
                        </Stack>
                        <Stack direction={'row'} justifyContent="flex-start" alignItems="center" spacing={1}>
                          <Typography variant="body1">전화번호</Typography>
                          <TextField size="small" value={'02-3456-7890'} />
                        </Stack>
                        <Stack
                          flexGrow={1}
                          direction={'row'}
                          ...
                          spacing={1}
                        >
                          <Typography sx={{ width: '3rem' }} variant="body1">
                            이메일
                          </Typography>
                          <TextField
                            size="small"
                    ...
                    <BtContentGrid gridXs={12} title={'대표이사 정보'}>
                      <Stack direction={'row'} spacing={2} sx={{ width: '100%' }}>
                        ...
                        >
                          ...
                          <TextField size="small" value={''} sx={{ boxSizing: 'border-box', width: '100%' }} />
                        </Stack>
                        <Box sx={{ px: 2 }}>
                          <IconButton size="small" sx={{ border: `1px solid ${theme.palette.text.sub}` }}>
                            <Remove />
                          </IconButton>
                        </Box>
                      </Stack>
...
export default InvmCnvrsRegViewBcck
