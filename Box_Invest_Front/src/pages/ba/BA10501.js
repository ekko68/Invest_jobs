                ...
                <Paper  sx={{p:4}}>
                    <Stack direction={'column'} alignItems={'center'} spacing={3}>
                        ...
                        <Stack direction={'row'} spacing={2}>
                            <Button variant="contained" onClick={()=>history.push(ROUTER_NAMES.BA10502)} disableElevation>
                                대출 추천서 제출
                            </Button>
                            <Button variant="contained" onClick={()=>history.push(ROUTER_NAMES.BA10503)} disableElevation>
                                추천 내역 보기
                            </Button>
                        </Stack>
                    </Stack>
