...
import {AlertLabels, FileUploadExtOpt, UsisType} from "modules/consts/BizConst";
...
const StampWrite = (props) => {
    ...
    const loadStampInfo = async () => {
        const resDataObj = await ResponseUtils.getSimpleResponse(Api.my.company.seal, null, false);
    ...
    return (
        <div className="layout">
                        ...
                        <div className="section section06">
                            <div className="section_header">
                                ...
                                <div className="btn_group">
                                    <Button onClick={() => history.push(ROUTER_NAMES.MY_PAGE_COMPANY_INFO)}>취소</Button>
            ...
            <CheckCloseCallBackAlertPopup ref={autoCloseCallBackPopupRef} callBack={() => history.push(ROUTER_NAMES.MY_PAGE_COMPANY_INFO)} />
        </div>
    )
}
