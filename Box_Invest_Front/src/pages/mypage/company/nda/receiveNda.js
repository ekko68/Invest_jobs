...
const ReceiveNda = (props) => {
    ...
    const tabProps = {
        ...props,
        tabType: ListType.RECEIVE,
        history: history,
        receiveRouter: ROUTER_NAMES.MY_PAGE_COMPANY_NDA_RECEIVE,
        sendRouter: ROUTER_NAMES.MY_PAGE_COMPANY_NDA_SEND,
    }
    ...
    const listProps = {
        ...
        tabName: '받은요청',
        noResultMsg: '요청받으신 NDA 체결 정보가 없습니다.',
        apiUrl: Api.my.company.ndaReceiveList,
        routerUrl: ROUTER_NAMES.MY_PAGE_COMPANY_NDA_VIEW + '?type=receive'
    }
                            ...
                            <div className="section_header">
                                ...
                                <div className="btn_group">
                                    <Button className={'blue'}
                                            onClick={() => history.push(ROUTER_NAMES.MY_PAGE_COMPANY_NDA_WRITE + '?type=receive')}>
                                        작성하기
                                    </Button>
                                </div>
                            </div>
