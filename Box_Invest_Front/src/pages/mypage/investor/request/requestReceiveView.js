...
const RequestReceiveView = (props) => {
  ...
  const { numberProperty = 'name', values, format } = props
  ...
  return (
    <>
      ...
      <div className="page_container">
        <div className="wrap mypage_wrap info_wrap request_wrap mypage_common bg02">
