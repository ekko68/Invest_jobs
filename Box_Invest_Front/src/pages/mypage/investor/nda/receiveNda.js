...
const ReceiveNda = (props) => {
    ...
    const listProps = {
        ...
        apiUrl: Api.my.vc.ndaReceiveList,
        routerUrl: ROUTER_NAMES.MY_PAGE_INVESTOR_NDA_VIEW + '?type=receive'
    }
                            ...
                            <div className="section_header">
                                ...
                                <div className="btn_group">
                                    <Button className={'blue'}
                                            onClick={() => history.push(ROUTER_NAMES.MY_PAGE_INVESTOR_NDA_WRITE + '?type=receive')}>
                                        작성하기
                                    </Button>
                                </div>
                            </div>
