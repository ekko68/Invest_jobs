...
const InvmOrrpListViewPopupRegister = (props) => {
  const { onCancel, onRegister } = props
            ...
            <Grid item xs={6}>
              <Box display={'flex'} justifyContent={'center'} alignItems={'center'}>
                <Button
                  ...
                  color="primary"
                  variant="contained"
                  onClick={() => onRegister(section, file.file)}
...
export default InvmOrrpListViewPopupRegister
