                ...
                <Paper  sx={{p:4}}>
                    <Stack direction={'column'} spacing={4}>
                        ...
                        <Stack direction={'row'} spacing={1} justifyContent="center" alignItems="center">
                            <Button size="large" variant="outlined" onClick={()=>history.push(ROUTER_NAMES.BA10301)} disableElevation>저장 및 종료</Button>
                            <Button size="large" variant="outlined" disableElevation>PDF 다운로드</Button>
                            <Button size="large" variant="outlined" onClick={()=>history.push(ROUTER_NAMES.BA10302)} disableElevation>이전</Button>
                            <Button size="large" variant="contained" onClick={()=>history.push(ROUTER_NAMES.BA10304)} disableElevation>저장 후 다음</Button>
                        </Stack>
                    </Stack>
                </Paper>
            </Stack>
