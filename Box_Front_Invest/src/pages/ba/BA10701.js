                    ...
                    <Grid xs={12}>
                      <Box sx={{ p: 2 }}>
                        <Typography variant="body1">
                          혁신을 주도하는 투자사 Boomco
                          <br />
                          저희가 추구하는 투자의 핵심은 고객의 가치를 극대화시켜 장기적으로 ‘창업’과 ‘투자’가 ....
                          따라서 앞으로도 차별화되는 투자전략 및 기회를 모색하여 정부, 금융, 종합 IT 그룹 및 .... 소중한
                          동반자들께 고객을 향해 더 높은 가치 실현을 집중해 갈 것을 약속드립니다. (주)넥스파트너스는
                          ‘성실’, ‘도전’, ‘고객만족’의 3대 핵심가치를 바탕으로 미래의 글로벌 .... 회사가 될 수 있도록
                          끊임없이 노력해 나아가겠습니다. 관심과 격려 부탁드립니다. 감사합니다.
                        </Typography>
                      </Box>
                    </Grid>
                  </Grid>
                  ...
                  <Table sx={{ minWidth: 650 }} size="small" aria-label="simple table">
                    ...
                    <TableBody>
                      <TableRow sx={{ backgroundColor: theme.palette.background.tableOddRow }}>
                        ...
                        >
                          S202306_(투자팀)_(조합명)_간접투자기구 자산현황.xlsx
                        </TableCell>
                        <TableCell align="center" component="th" scope="row">
                          <Button variant="outlined" disableElevation>
                            수정
