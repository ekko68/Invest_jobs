            ...
            <Stack spacing={4} direction={'column'} sx={{py:5}}>
                ...
                <Stack  spacing={1}>
                    <Stack direction={'row'} alignItems="flex-end" spacing={1} >
                        <Box flexGrow={1}/>
                        <Button disableElevation color="primary" variant="contained" onClick={()=>history.push(ROUTER_NAMES.BA10302)}>
                            신규 펀드 제안
                        </Button>
                    </Stack>
                            ...
                            <Table sx={{ minWidth: 650 }} size="small" aria-label="simple table">
                                ...
                                <TableBody>
                                    ...
                                    <TableRow sx={{backgroundColor:theme.palette.background.tableOddRow}}>
                                        ...
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Button color="primary" size="small" variant="outlined" sx={{width:'100%'}} onClick={()=>history.push(ROUTER_NAMES.BA10302)}>계속작성</Button>
                                        </TableCell>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Button color="primary" size="small"  variant="outlined" sx={{width:'100%'}} onClick={()=>history.push(ROUTER_NAMES.BA10305)}>계속작성</Button>
                                        </TableCell>
