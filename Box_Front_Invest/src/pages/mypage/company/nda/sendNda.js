...
const SendNda = (props) => {
    ...
    const listProps = {
        ...
        apiUrl: Api.my.company.ndaSendList,
        routerUrl: ROUTER_NAMES.MY_PAGE_COMPANY_NDA_VIEW + '?type=send'
    }
                            ...
                            <div className="section_header">
                                ...
                                <div className="btn_group">
                                    <Button className={'blue'}
                                            onClick={() => history.push(ROUTER_NAMES.MY_PAGE_COMPANY_NDA_WRITE + '?type=send')}>
                                        작성하기
                                    </Button>
                                </div>
                            </div>
