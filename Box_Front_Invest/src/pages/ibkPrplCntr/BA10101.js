import { FiberManualRecordOutlined, HomeOutlined, PersonOutlineOutlined } from "@mui/icons-material";
import { Avatar, Box, Button, Chip, Container, Divider, Grid, IconButton, MenuItem, Pagination, PaginationItem, Paper, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography, useTheme } from "@mui/material";
            ...
            <Stack spacing={4} direction={'column'} sx={{py:5}}>
                ...
                <Stack  spacing={1}>
                    <Stack direction={'row'} alignItems="flex-end" spacing={1} >
                        ...
                        <Button disableElevation color="primary" variant="contained" onClick={()=>history.push(ROUTER_NAMES.INVM_CNVRS_REG_VIEW)}>
                            투자사전환요청
                        </Button>
