...
const Header = (props) => {
  ...
  useEffect(() => {
    if (scrollY > 70) setHeaderActive(true)
        ...
        <ul className="tnb_left">
          ...
          <li className="tnb_item">
            <Link
              ...
              onClick={(e) => {
                e.preventDefault()
                window.open(process.env.REACT_APP_GNB_LINK_ACO, '_self')
              }}
            >
              계좌개설
            </Link>
          ...
          <li className="tnb_item">
            <Link
              ...
              onClick={(e) => {
                e.preventDefault()
                window.open(process.env.REACT_APP_GNB_LINK_BOKS, '_self')
              }}
            >
              장부자금관리
            </Link>
          ...
          <li className="tnb_item">
            <Link
              ...
              onClick={(e) => {
                e.preventDefault()
                window.open(process.env.REACT_APP_GNB_LINK_COMMERCE, '_self')
              }}
            >
              기업홍보관
            </Link>
          ...
          <li className="tnb_item">
            <Link
              ...
              onClick={(e) => {
                e.preventDefault()
                window.open(process.env.REACT_APP_GNB_LINK_MNB + '?boxspa=false', '_self')
              }}
            >
              비즈톡
            </Link>
          ...
          <li className="tnb_item">
            <Link
              ...
              onClick={(e) => {
                e.preventDefault()
                window.open(process.env.REACT_APP_GNB_LINK_GLOB, '_self')
              }}
            >
              해외진출
            </Link>
          ...
          <li className="tnb_item">
            <Link
              ...
              onClick={(e) => {
                e.preventDefault()
                window.open(process.env.REACT_APP_GNB_LINK_ESG, '_self')
              }}
            >
              ESG
            </Link>
            ...
            {page === 'main' ? (
              <h1 className="logo">
                <div style={{ cursor: 'pointer' }} onClick={(event) => onClickGoToMain(event)}>
                  <img src="/images/logo_ibk.png" alt="IBK 투자박스 로고 이미지" />
                  <span className="logoNm">투자박스</span>
                </div>
              </h1>
            ) : (
              <h1 className="logo">
